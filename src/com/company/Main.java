...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Truck[] trucks = {new Truck(1, "Volvo FH12", "", "base"),
                new Truck(2, "Renault   ", "", "base"),
                new Truck(3, "Maz       ", "", "base")
        };
        Driver[] drivers = {new Driver(1, "Andrew  ","driver-1"),
                new Driver(2,"Mane    ", "driver-2"),
                new Driver(3, "Rashword","driver-3")
        };
